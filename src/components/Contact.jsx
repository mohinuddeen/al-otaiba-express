        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg h-64">
              <iframe
                title="AOE Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d231078.50669410806!2d54.94751995!3d25.2048493!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e5084295162!2sDubai%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2s!4v1700000000000!5m2!1sen!2s"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-navy-900 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 transform hover:scale-105 inline-flex items-center justify-center gap-2"
              >
                Send Message
